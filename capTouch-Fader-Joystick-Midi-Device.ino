...
Potentiometer fader4(faderPin4, midiChannel, 23, secondary, debug);
...
//  delay(200);
  ...
  enc1 = new MIDIEncoder(25,12,midiChannel,34,true, false);
  enc2 = new MIDIEncoder(11,9,midiChannel,35,true, false);
  enc3 = new MIDIEncoder(8,6,midiChannel,36,true, false);
  enc4 = new MIDIEncoder(5,3,midiChannel,37,true, false);
  enc5 = new MIDIEncoder(2,13,midiChannel,38,true, false);
...
//      touchValue = touchRead(touchPin[i]);  // Serial.print("touchPin: ");  // Serial.print(touchPin[i]);  // Serial.print(" ");  // Serial.print("Value: ");  // Serial.println(touchValue);   if(touchValue > 2400 && !touchState[i]) {
...
//  // Below is some code for adding a pot and button as MIDI CCs   
//  if(msec >= 20) {
//    msec = 0;
//  }
